...
const AsideFilter = (props) => {
  ...
  const [active, setActive] = useState(
    JSON.parse(window.localStorage.getItem("active")) || { activeFilter: "all" }
  );
  ...
  return (
    <div className="aside-filter">
      <p
        className={`aside-filter-link ${checkSelected(
          "all",
          active.activeFilter
        )}`}
      ...
      <p
        ...
        onClick={() => filterHandleClick("enhancement")}
      >
        Enhancement
      </p>
      <p
      ...
      <p
        ...
        onClick={() => filterHandleClick("feature")}
      >
        Feature
      </p>
    </div>
